...
| 🎧 **聽力** | 81 組情境短文 + 226 道英文理解測驗，用瀏覽器 TTS 朗讀 |
| ✍️ **中翻英** | 279 題，161 題句中填空 + 118 題整句翻譯 |
| 💬 **情境對話** | 61 段角色扮演，185 句你的台詞；對方由 TTS 扮演 |
...
│   ├── listening.json    # 81 組聽力題（題目與選項為英文，解析為中文）
│   ├── translation.json  # 279 題中翻英（填空 + 整句）
│   └── dialogues.json    # 61 段情境對話
├── server/
...
現有的題庫是手寫的，這個腳本是給你之後想再擴充時用的 —— 它的價值主要在那套驗證，
而不是生成本身。
