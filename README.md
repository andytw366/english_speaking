...
| 🎧 **聽力** | 24 組情境短文 + 66 道英文理解測驗，用瀏覽器 TTS 朗讀 |
| ✍️ **中翻英** | 80 題，40 題句中填空 + 40 題整句翻譯 |
| 💬 **情境對話** | 20 段角色扮演，61 句你的台詞；對方由 TTS 扮演 |
...
│   ├── listening.json    # 24 組聽力題（題目與選項為英文，解析為中文）
│   ├── translation.json  # 80 題中翻英（填空 + 整句）
│   └── dialogues.json    # 20 段情境對話
├── server/
