// 對完答案之後最上面那兩句：**AI 改的那句在上，教材的例句在下**。
//
// 為什麼是「兩句並列」而不是一張 AI 卡加一張例句卡：
// 使用者寫完一句話之後只想知道一件事 —— 「那到底該怎麼說」。
// 這個問題有兩個答案，而它們回答的角度不一樣：
//
//   🤖 AI 改的     看的是**你寫的那一句**，把它改成母語人士會說的樣子
//   📘 例句        教材寫死的那一句（免費、離線、每次都一樣）
//
// 教材那句**只是一個例句**，不是標準答案 —— 這一題算好算壞由模型判
// （見 `lib/verdict.js`）。同一個意思本來就有很多種講法，把其中一種當標準，
// 使用者寫出更自然的說法反而會被判錯。
//
