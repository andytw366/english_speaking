...
function render() {
  ...
  if (unsupported) {
    append(root, h('div', { class: 'banner banner--error' }, unsupported));
    return;
  }
...
async function submit() {
  ...
  append(form, 'audio', wavBlob, 'recording.wav');
  append(form, 'sentence', current.text);
